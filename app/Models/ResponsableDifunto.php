...
// select "responsable_difunto".*, "responsable"."segundo_apellido" as "segap_resp",
//  "responsable"."fecha_nacimiento" as "nacimiento_resp", "responsable"."telefono",
//   "responsable"."celular", "responsable"."estado_civil" as "ecivil_resp",
//    "responsable"."genero" as "genero_resp", "responsable"."email" as "email_resp", 
//    "responsable"."domicilio" as "domicilio_resp", "responsable"."ci" as "ci_resp",
//     "responsable"."nombres" as "nombre_resp", "responsable"."primer_apellido" as "paterno_resp",
//      "responsable"."segundo_apellido" as "segap_resp", "difunto"."ci" as "ci_dif", 
//      "difunto"."nombres" as "nombre_dif", "difunto"."primer_apellido" as "primerap_dif",
//       "difunto"."segundo_apellido" as "segap_dif", "difunto"."segundo_apellido" as "segap_dif",
//        "difunto"."fecha_nacimiento" as "nacimiento_dif", "difunto"."fecha_defuncion" as "fecha_def_dif",
//         "difunto"."causa" as "causa_dif", "difunto"."tipo" as "tipo_dif", "difunto"."certificado_defuncion",
//          "difunto"."genero" as "genero_dif", "difunto"."certificado_file", "difunto"."funeraria",
//           "nicho"."tipo" as "tipo_nicho", "nicho"."codigo" as "nicho", "nicho"."codigo_anterior" as "anterior",
//            "bloque"."codigo" as "bloque", "cuartel"."codigo" as "cuartel", "nicho"."nro_nicho",
//             "nicho"."cantidad_cuerpos"
//              from "responsable_difunto" 
//              left join "responsable" on "responsable"."id" = "responsable_difunto"."responsable_id" 
//              left join "difunto" on "difunto"."id" = "responsable_difunto"."difunto_id" 
//              inner join "nicho" on "nicho"."codigo" = "responsable_difunto"."codigo_nicho"
//               left join "cuartel" on "cuartel"."id" = "nicho"."cuartel_id"
//                left join "bloque" on "bloque"."id" = "nicho"."bloque_id"
//                 where "bloque"."codigo" = '001' and "nicho"."nro_nicho" = '00011' and "nicho"."fila" = '1' limit 1,
...
//        "nicho"."tipo" as "tipo_nicho", "nicho"."codigo" as "nicho", "nicho"."codigo_anterior" as "anterior",
//         "bloque"."codigo" as "bloque", "cuartel"."codigo" as "cuartel", "nicho"."nro_nicho",
//          "nicho"."cantidad_cuerpos" from "responsable_difunto1" 
//          left join "responsable" on "responsable"."id" = "responsable_difunto"."responsable_id" 
//          left join "difunto" on "difunto"."id" = "responsable_difunto"."difunto_id" 
//          inner join "nicho" on "nicho"."codigo" = "responsable_difunto"."codigo_nicho" 
//          left join "cuartel" on "cuartel"."id" = "nicho"."cuartel_id" 
//          left join "bloque" on "bloque"."id" = "nicho"."bloque_id" 
//          where "responsable_difunto"."codigo_nicho"::text ilike %62P.00068.2% and 
//          "responsable_difunto"."estado" = ACTIVO order by "responsable_difunto"."id" desc
