...
<div class="modal fade fullscreen-modal animated bounceIn" tabindex="-1" id="modal-register-servicio" data-backdrop="static" tabindex="-1" role="dialog"
aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title" style="text-align: center">ASIGNACION SERVICIOS</h3>
